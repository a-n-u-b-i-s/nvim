...
map("n", "<leader>qw", "<cmd>wqa<cr>", { desc = "Quit (Write) all" })
...
-- file explorer
map("n", "<leader>e", "<cmd>Oil --float<cr>", { desc = "Open File Browser", noremap = true, nowait = true })
...
map("n", "<leader>gl", "<cmd>LazyGit<cr>", { desc = "LazyGit", nowait = true, noremap = true })
map(
	"n",
	"<leader>gt",
	"<cmd>lua require('telescope').extensions.lazygit.lazygit()<cr>",
	{ desc = "LazyGit (Telescope)", nowait = true, noremap = true }
)
