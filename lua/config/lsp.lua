		...
		opts = {
			...
			servers = {
				...
				unocss = {
					cmd = {
						"node",
						"/Users/anubis/.local/share/nvim/mason/packages/unocss-language-server/node_modules/.bin/unocss-language-server",
						"--stdio",
					},
				},
				jsonls = {},
				...
				eslint = function()
					vim.api.nvim_create_autocmd("BufWritePre", {
						callback = function(event)
							if not require("config.lsp-format").enabled() then
